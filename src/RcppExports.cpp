...
// FMeanCI
Rcpp::List FMeanCI(const std::string dir, const int n_files, const arma::vec time, const int basis_degree, const arma::vec boundary_knots, const arma::vec internal_knots, const int k, const double alpha, bool rescale, const bool simultaneous, const double burnin_prop, Rcpp::Nullable<Rcpp::NumericMatrix> X, Rcpp::Nullable<Rcpp::NumericMatrix> trans_mats);
RcppExport SEXP _BayesFMMM_FMeanCI(SEXP dirSEXP, SEXP n_filesSEXP, SEXP timeSEXP, SEXP basis_degreeSEXP, SEXP boundary_knotsSEXP, SEXP internal_knotsSEXP, SEXP kSEXP, SEXP alphaSEXP, SEXP rescaleSEXP, SEXP simultaneousSEXP, SEXP burnin_propSEXP, SEXP XSEXP, SEXP trans_matsSEXP) {
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< Rcpp::Nullable<Rcpp::NumericMatrix> >::type trans_mats(trans_matsSEXP);
    rcpp_result_gen = Rcpp::wrap(FMeanCI(dir, n_files, time, basis_degree, boundary_knots, internal_knots, k, alpha, rescale, simultaneous, burnin_prop, X, trans_mats));
...
// FCovCI
Rcpp::List FCovCI(const std::string dir, const int n_files, const arma::vec time1, const arma::vec time2, const int basis_degree, const arma::vec boundary_knots, const arma::vec internal_knots, const int l, const int m, const double alpha, bool rescale, const bool simultaneous, const double burnin_prop, Rcpp::Nullable<Rcpp::NumericMatrix> X, Rcpp::Nullable<Rcpp::NumericMatrix> trans_mats);
RcppExport SEXP _BayesFMMM_FCovCI(SEXP dirSEXP, SEXP n_filesSEXP, SEXP time1SEXP, SEXP time2SEXP, SEXP basis_degreeSEXP, SEXP boundary_knotsSEXP, SEXP internal_knotsSEXP, SEXP lSEXP, SEXP mSEXP, SEXP alphaSEXP, SEXP rescaleSEXP, SEXP simultaneousSEXP, SEXP burnin_propSEXP, SEXP XSEXP, SEXP trans_matsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const std::string >::type dir(dirSEXP);
    ...
    Rcpp::traits::input_parameter< Rcpp::Nullable<Rcpp::NumericMatrix> >::type X(XSEXP);
    Rcpp::traits::input_parameter< Rcpp::Nullable<Rcpp::NumericMatrix> >::type trans_mats(trans_matsSEXP);
    rcpp_result_gen = Rcpp::wrap(FCovCI(dir, n_files, time1, time2, basis_degree, boundary_knots, internal_knots, l, m, alpha, rescale, simultaneous, burnin_prop, X, trans_mats));
    return rcpp_result_gen;
END_RCPP
}
// HDFCovCI
...
// FBIC
double FBIC(const std::string dir, const int n_files, const int basis_degree, const arma::vec boundary_knots, const arma::vec internal_knots, const arma::field<arma::vec> time, const arma::field<arma::vec> Y, const double burnin_prop, Rcpp::Nullable<Rcpp::NumericMatrix> X, const bool cov_adj);
RcppExport SEXP _BayesFMMM_FBIC(SEXP dirSEXP, SEXP n_filesSEXP, SEXP basis_degreeSEXP, SEXP boundary_knotsSEXP, SEXP internal_knotsSEXP, SEXP timeSEXP, SEXP YSEXP, SEXP burnin_propSEXP, SEXP XSEXP, SEXP cov_adjSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const std::string >::type dir(dirSEXP);
    ...
    Rcpp::traits::input_parameter< Rcpp::Nullable<Rcpp::NumericMatrix> >::type X(XSEXP);
    Rcpp::traits::input_parameter< const bool >::type cov_adj(cov_adjSEXP);
    rcpp_result_gen = Rcpp::wrap(FBIC(dir, n_files, basis_degree, boundary_knots, internal_knots, time, Y, burnin_prop, X, cov_adj));
    return rcpp_result_gen;
END_RCPP
}
// FLLik
...
// MVAIC
double MVAIC(const std::string dir, const int n_files, const arma::mat Y, const double burnin_prop, Rcpp::Nullable<Rcpp::NumericMatrix> X, const bool cov_adj);
RcppExport SEXP _BayesFMMM_MVAIC(SEXP dirSEXP, SEXP n_filesSEXP, SEXP YSEXP, SEXP burnin_propSEXP, SEXP XSEXP, SEXP cov_adjSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const std::string >::type dir(dirSEXP);
    ...
    Rcpp::traits::input_parameter< Rcpp::Nullable<Rcpp::NumericMatrix> >::type X(XSEXP);
    Rcpp::traits::input_parameter< const bool >::type cov_adj(cov_adjSEXP);
    rcpp_result_gen = Rcpp::wrap(MVAIC(dir, n_files, Y, burnin_prop, X, cov_adj));
    return rcpp_result_gen;
END_RCPP
}
// MVBIC
double MVBIC(const std::string dir, const int n_files, const arma::mat Y, const double burnin_prop, Rcpp::Nullable<Rcpp::NumericMatrix> X, const bool cov_adj);
RcppExport SEXP _BayesFMMM_MVBIC(SEXP dirSEXP, SEXP n_filesSEXP, SEXP YSEXP, SEXP burnin_propSEXP, SEXP XSEXP, SEXP cov_adjSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const std::string >::type dir(dirSEXP);
    ...
    Rcpp::traits::input_parameter< Rcpp::Nullable<Rcpp::NumericMatrix> >::type X(XSEXP);
    Rcpp::traits::input_parameter< const bool >::type cov_adj(cov_adjSEXP);
    rcpp_result_gen = Rcpp::wrap(MVBIC(dir, n_files, Y, burnin_prop, X, cov_adj));
    return rcpp_result_gen;
END_RCPP
}
// MVDIC
double MVDIC(const std::string dir, const int n_files, const arma::mat Y, const double burnin_prop, Rcpp::Nullable<Rcpp::NumericMatrix> X, const bool cov_adj);
RcppExport SEXP _BayesFMMM_MVDIC(SEXP dirSEXP, SEXP n_filesSEXP, SEXP YSEXP, SEXP burnin_propSEXP, SEXP XSEXP, SEXP cov_adjSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const std::string >::type dir(dirSEXP);
    ...
    Rcpp::traits::input_parameter< Rcpp::Nullable<Rcpp::NumericMatrix> >::type X(XSEXP);
    Rcpp::traits::input_parameter< const bool >::type cov_adj(cov_adjSEXP);
    rcpp_result_gen = Rcpp::wrap(MVDIC(dir, n_files, Y, burnin_prop, X, cov_adj));
    return rcpp_result_gen;
END_RCPP
}
// MVLLik
...
arma::vec ConditionalPredictiveOrdinates(const std::string dir, const int n_files, const int basis_degree, const arma::vec boundary_knots, const arma::vec internal_knots, const arma::field<arma::vec> time, const arma::field<arma::vec> Y, const double burnin_prop, Rcpp::Nullable<Rcpp::NumericMatrix> X, const bool cov_adj, const bool log_CPO);
RcppExport SEXP _BayesFMMM_ConditionalPredictiveOrdinates(SEXP dirSEXP, SEXP n_filesSEXP, SEXP basis_degreeSEXP, SEXP boundary_knotsSEXP, SEXP internal_knotsSEXP, SEXP timeSEXP, SEXP YSEXP, SEXP burnin_propSEXP, SEXP XSEXP, SEXP cov_adjSEXP, SEXP log_CPOSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const std::string >::type dir(dirSEXP);
...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(BFMMM_Nu_Z_multiple_try(tot_mcmc_iters, n_try, K, Y, time, n_funct, basis_degree, n_eigen, boundary_knots, internal_knots, X, c, b, alpha1l, alpha2l, beta1l, beta2l, a_Z_PM, a_pi_PM, var_alpha3, var_epsilon1, var_epsilon2, alpha_nu, beta_nu, alpha_eta, beta_eta, alpha_0, beta_0));
    return rcpp_result_gen;
END_RCPP
}
// BFMMM_Theta_est
...
Rcpp::List BHDFMMM_Nu_Z_multiple_try(const int tot_mcmc_iters, const int n_try, const int K, const arma::field<arma::vec> Y, const arma::field<arma::mat> time, const int n_funct, const arma::vec basis_degree, const int n_eigen, const arma::mat boundary_knots, const arma::field<arma::vec> internal_knots, Rcpp::Nullable<Rcpp::NumericMatrix> X, Rcpp::Nullable<Rcpp::NumericVector> c, const double b, const double alpha1l, const double alpha2l, const double beta1l, const double beta2l, const double a_Z_PM, const double a_pi_PM, const double var_alpha3, const double var_epsilon1, const double var_epsilon2, const double alpha_nu, const double beta_nu, const double alpha_eta, const double beta_eta, const double alpha_0, const double beta_0);
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const double >::type alpha_0(alpha_0SEXP);
    Rcpp::traits::input_parameter< const double >::type beta_0(beta_0SEXP);
    rcpp_result_gen = Rcpp::wrap(BHDFMMM_Nu_Z_multiple_try(tot_mcmc_iters, n_try, K, Y, time, n_funct, basis_degree, n_eigen, boundary_knots, internal_knots, X, c, b, alpha1l, alpha2l, beta1l, beta2l, a_Z_PM, a_pi_PM, var_alpha3, var_epsilon1, var_epsilon2, alpha_nu, beta_nu, alpha_eta, beta_eta, alpha_0, beta_0));
    return rcpp_result_gen;
END_RCPP
}
// BHDFMMM_Theta_est
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_BayesFMMM_FBIC", (DL_FUNC) &_BayesFMMM_FBIC, 10},
    {"_BayesFMMM_FLLik", (DL_FUNC) &_BayesFMMM_FLLik, 9},
    {"_BayesFMMM_MVAIC", (DL_FUNC) &_BayesFMMM_MVAIC, 6},
    {"_BayesFMMM_MVBIC", (DL_FUNC) &_BayesFMMM_MVBIC, 6},
    ...
    {"_BayesFMMM_BHDFMMM_Nu_Z_multiple_try", (DL_FUNC) &_BayesFMMM_BHDFMMM_Nu_Z_multiple_try, 28},
