...
// // [[Rcpp::export]]
// arma::cube TestUpdateZTempered_MVCovariateAdjusted1(){
//   // Make nu matrix
//   arma::mat nu(3,8);
//   nu = {{2, 0, 1, 0, 0, 0, 1, 3},
//   {1, 3, 0, 2, 0, 0, 3, 0},
...
// //
// // [[Rcpp::export]]
// arma::field<arma::cube> TestUpdateDeltaXi1(){
...
//     xi(0,i) = arma::zeros(8,2,2);
//     for(int j =0; j < 2; j++){
//       xi(0,i).slice(j) = (2-j) * 0.1 * arma::randn<arma::mat>(8,2);
//     }
//   }
//   for(int i = 1; i < 250; i++){
//     for(int j = 0; j < 3; j++){
...
//     mod(1,i) = xi_est(0,i);
//   }
//   Rcpp::List mod1 = Rcpp::List::create(Rcpp::Named("mod", mod),
//                                        Rcpp::Named("xi_samp", xi_samp),
//                                        Rcpp::Named("gamma_xi", gamma_xi),
//                                        Rcpp::Named("tilda_tau_gamma",  tilde_tau_gamma),
//                                        Rcpp::Named("y", y_obs));
//   return mod1;
// }
