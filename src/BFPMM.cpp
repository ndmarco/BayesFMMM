...
//' @export
// [[Rcpp::export]]
Rcpp::List BFPMM_MTTMV(const arma::mat& y_obs,
                       const int& thinning_num,
                       const int& K,
                       const int& M,
                       const int& tot_mcmc_iters,
...
//' @export
// [[Rcpp::export]]
Rcpp::List BFPMM_Nu_ZMV(const arma::mat& y_obs,
                        const int& K,
                        const int& M,
                        const int& tot_mcmc_iters,
                        const arma::vec& c,
...
//' @export
// [[Rcpp::export]]
Rcpp::List BFPMM_ThetaMV(const arma::mat& y_obs,
                         const int& K,
                         const int& M,
                         const int& tot_mcmc_iters,
                         const arma::vec& c,
...
//' @export
// [[Rcpp::export]]
Rcpp::List BFPMM_MTT_warm_startMV(const arma::mat& y_obs,
                                  const int& thinning_num,
                                  const int& K,
                                  const int& M,
                                  const int& tot_mcmc_iters,
...
//' @export
// [[Rcpp::export]]
Rcpp::List BMFPMM_Theta(const arma::field<arma::vec>& y_obs,
                        const arma::field<arma::mat>& t_obs,
                        const int& n_funct,
                        const int& K,
                        const arma::vec& basis_degree,
