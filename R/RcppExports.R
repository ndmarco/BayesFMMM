...
#' @name GetStuff
#' @export
TestEstimateInitialTT <- function(tot_mcmc_iters, r_stored_iters, directory) {
    .Call('_BayesFOC_TestEstimateInitialTT', PACKAGE = 'BayesFOC', tot_mcmc_iters, r_stored_iters, directory)
}
