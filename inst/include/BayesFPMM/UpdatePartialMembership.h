#ifndef BayesFPMM_UPDATE_PARTIAL_MEMBERSHIP_H
#define BayesFPMM_UPDATE_PARTIAL_MEMBERSHIP_H
...
// @param Z_ph Matrix that acts as a placeholder for Z
// @param Z Cube that contains all past, current, and future MCMC draws
inline void updateZ_PMMV(const arma::mat& y_obs,
                         const arma::cube& Phi,
                         const arma::mat& nu,
                         const arma::mat& chi,
                         const arma::vec& pi,
...
// @param Z_ph Matrix that acts as a placeholder for Z
// @param Z Cube that contains all past, current, and future MCMC draws
inline void updateZTempered_PMMV(const double& beta_i,
